...
const categoryLinks = [
  ...
  { href: "/popular", text: "Popular", icon: "popular" },
  { href: "/now-playing", text: "Now Playing", icon: "now-playing" },
  { href: "/upcoming", text: "Upcoming", icon: "upcoming" },
  { href: "/top-rated", text: "Top Rated", icon: "top-rated" },
];
      ...
      <div className="grid grid-cols-2 md:flex md:flex-row md:justify-between md:items-center gap-4">
        {categoryLinks.map((link, index) => (
          <React.Fragment key={index}>
            {index !== 0 && (
              <Typography className="text-white text-lg hidden md:block">
                |
              </Typography>
            )}
