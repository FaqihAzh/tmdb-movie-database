...
import { LoginAct } from "../../features/actions/authActions/authLogin";
import { toast } from "react-toastify";
import { useGoogleLogin } from "@react-oauth/google";
import { CookieKeys, CookieStorage } from "../../utils/constants/cookies";
import axios from "axios";
import ENDPOINTS from "../../utils/constants/endpoint";
import { setToken } from "../../features/reducers/authSlice/authLogin";
  ...
  const registerLoginWithGoogleAction = async (accessToken) => {
    try {
      ...
      let config = {
        ...
        url: `${process.env.REACT_APP_BINAR_BASE_URL}${ENDPOINTS.AUTH_GOOGLE}`,
        headers: {
