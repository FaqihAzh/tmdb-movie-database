...
const DetailMovie = () => {
  const movie = useSelector((store) => store.movies.details);
  ...
  const rate = movie.vote_average && movie.vote_average.toFixed(1);
  ...
  const trailer =
    url && movie
      ? `https://www.youtube.com/watch?v=${url.key}`
      : movie && movie.videos && movie.videos.results && movie.videos.results[0]
            ...
            <div className="flex flex-col gap-4">
              <Typography variant="title">
                ...
                <span className="font-semibold">
                  ({movie.release_date ? date : date_series})
                </span>
              </Typography>
